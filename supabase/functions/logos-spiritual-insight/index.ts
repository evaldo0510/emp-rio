      ...
      const response = await fetch("https://api.lovable.ai/v1/chat/completions", {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: "Você é um especialista em branding e design espiritual. Gere uma descrição detalhada e insights para um logo baseado no prompt do usuário. Retorne um JSON com 'description', 'colors', 'symbols' e 'rationale'."
            },
            {
              role: "user",
              content: prompt
